...
export default function Footer() {
  return (
    <footer   className="relative w-full overflow-hidden bg-[#050505] text-[#F7F1E8]">
        ...
        <div className="flex-1">
          <div className="max-w-[760px]">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              {[
                { icon: <Instagram size={20} />, href: "/https://www.instagram.com/petitedumpling/?igshid=YmMyMTA2M2Y%3D" },
                { icon: <Facebook size={20} />, href: "/https://www.facebook.com/people/Petite-Dumpling/100087060717669/" },
                { icon: <Music2 size={20} />, href: "#" },
              ].map((item, index) => (
                <a
                  key={index}
                  href={item.href}
      ...
      {/* bottom */}
      <div className="border-t border-white/8 px-6 py-5 text-center sm:px-10 md:px-14 lg:px-20">
        <p
